package com.linkto.invoker.dapp_client.manage;
...
import com.linkto.invoker.dapp_client.model.BaseResultModel;
import com.linkto.invoker.dapp_client.model.Contract;
import com.linkto.invoker.dapp_client.model.SignMessage;
import com.linkto.invoker.dapp_client.model.Transfer;
import com.linkto.invoker.helper.AppHelper;
...
public class DpInvokerManager {
	...
	private static final String Dp_SCHEME_HOST = "cocosbcx://dappx.com";
